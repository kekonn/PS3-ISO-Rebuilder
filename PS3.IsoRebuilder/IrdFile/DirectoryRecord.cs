    ...
    public class DirectoryRecord
    {
        ...
        public DirectoryRecord(byte[] buffer, int offset, Encoding enc)
        {
            ...
            checked
            {
                ...
                try
                {
                    var dateTime = new DateTime(1900 + (int)buffer[checked(18 + offset)], buffer[19 + offset], buffer[20 + offset], buffer[21 + offset], buffer[22 + offset], buffer[23 + offset]);
                    var dateTime2 = dateTime;
                    RecordingDateAndTime = dateTime2.AddHours(4 * (int)buffer[checked(24 + offset)]);
                }
